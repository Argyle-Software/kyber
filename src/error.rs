...
pub enum KyberError
{
  /// One or more inputs to a function are incorrectly sized. A likely cause of
  /// this is two parties using different security levels while trying to
  /// negotiate a key exchange.
  InvalidInput,
  ...
  fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result
  {
    match *self {
      KyberError::InvalidInput => {
        write!(f, "Function input is of incorrect length")
      }
