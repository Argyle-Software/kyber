...
pub unsafe fn poly_compress10(r: &mut [u8], a: &Poly)
{
  ...
  let shufbidx = _mm256_set_epi8(
    8, 4, 3, 2, 1, 0, -1, -1, -1, -1, -1, -1, 12, 11, 10, 9, -1, -1, -1, -1,
...
pub unsafe fn poly_decompress10(r: &mut Poly, a: &[u8])
{
  ...
  let shufbidx = _mm256_set_epi8(
    11, 10, 10, 9, 9, 8, 8, 7, 6, 5, 5, 4, 4, 3, 3, 2, 9, 8, 8, 7, 7, 6, 6, 5,
    4, 3, 3, 2, 2, 1, 1, 0,
  );
...
pub unsafe fn poly_compress11(r: &mut [u8], a: &Poly)
{
  ...
  let shufbidx = _mm256_set_epi8(
    4, 3, 2, 1, 0, 0, -1, -1, -1, -1, 10, 9, 8, 7, 6, 5, -1, -1, -1, -1, -1,
...
pub unsafe fn poly_decompress11(r: &mut Poly, a: &[u8])
{
  ...
  let shufbidx = _mm256_set_epi8(
    13, 12, 12, 11, 10, 9, 9, 8, 8, 7, 6, 5, 5, 4, 4, 3, 10, 9, 9, 8, 7, 6, 6,
    5, 5, 4, 3, 2, 2, 1, 1, 0,
  );
