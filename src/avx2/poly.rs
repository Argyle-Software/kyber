...
pub unsafe fn poly_decompress(r: &mut Poly, a: &[u8])
{
  ...
  let shufbidx: __m256i = _mm256_set_epi8(
    7, 7, 7, 7, 6, 6, 6, 6, 5, 5, 5, 5, 4, 4, 4, 4, 3, 3, 3, 3, 2, 2, 2, 2, 1,
    1, 1, 1, 0, 0, 0, 0,
  );
...
pub unsafe fn poly_compress(r: &mut [u8], a: Poly)
{
  ...
  let shufbidx: __m256i = _mm256_set_epi8(
    8, -1, -1, -1, -1, -1, 4, 3, 2, 1, 0, -1, 12, 11, 10, 9, -1, 12, 11, 10, 9,
    8, -1, -1, -1, -1, -1, 4, 3, 2, 1, 0,
  );
...
pub unsafe fn poly_decompress(r: &mut Poly, a: &[u8])
{
  ...
  let shufbidx = _mm256_set_epi8(
    9, 9, 9, 8, 8, 8, 8, 7, 7, 6, 6, 6, 6, 5, 5, 5, 4, 4, 4, 3, 3, 3, 3, 2, 2,
    1, 1, 1, 1, 0, 0, 0,
  );
  let mask = _mm256_set_epi16(
    248, 1984, 62, 496, 3968, 124, 992, 31, 248, 1984, 62, 496, 3968, 124, 992,
    31,
  );
